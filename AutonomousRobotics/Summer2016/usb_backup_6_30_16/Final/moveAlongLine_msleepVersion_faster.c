...
//this code is just like the 'moveAlongLine_bmdVersion.c'. That file has more comments on what the actual code is doing
//the difference between these two files is:
//everywhere you see bmd(...); in the '...bmdVersion.c' here you'll actually see the
//msleep(...) function
