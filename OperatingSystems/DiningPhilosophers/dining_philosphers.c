...
#define clear_eol(x) print(x, 12, "\033[K") //clear_eol clears the current field's value from the current cursor position to the end of lthe line or field.
...
int main()
{
	int i, id[N]; //the id int is an array that is initialized to the number of philosophers at the table
	pthread_t tid[N]; //a pthread_t array of size 5 (the number of philosophers)
