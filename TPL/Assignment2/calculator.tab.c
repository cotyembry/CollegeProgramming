...
{
  "$end", "error", "$undefined", "FLOAT", "INTEGER", "'+'", "'-'", "'*'",
  "'/'", "'%'", "'('", "')'", "$accept", "start", "expr", "term", "factor", YY_NULL
};
#endif
...
#line 38 "calculator.y"
    { (yyval.fval) = (yyvsp[(1) - (1)].fval); isFloat = 1;}
    break;
