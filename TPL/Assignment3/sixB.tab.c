...
/* In a future release of Bison, this section will be replaced
   by #include "sixB.tab.h".  */
#ifndef YY_YY_SIXB_TAB_H_INCLUDED
# define YY_YY_SIXB_TAB_H_INCLUDED
/* Enabling traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_SIXB_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "INTEGER", "DOUBLE", "$accept", "start",
  "expr", "factor", YY_NULL
};
#endif
...
/* Line 1787 of yacc.c  */
#line 34 "sixB.y"
    {   if ((smbRecord = lookup(symbols, "expr")) != NULL ) {
...
#line 60 "sixB.y"
    {
            if ((smbRecord = lookup(symbols, "factor")) != NULL ) {
                ...
                setValue(smbRecord, (yyvsp[(1) - (1)].sval));
            } // end if
