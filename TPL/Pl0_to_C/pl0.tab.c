...
{
       0,    74,    74,    85,    91,    95,   100,   105,   115,   127,
     137,   154,   164,   168,   172,   186,   192,   201,   206,   212,
     230,   236,   244,   252,   257,   261,   265,   273,   276,   281,
     284,   287,   290,   294,   297,   305,   314,   317,   324,   333,
     336,   339
};
#endif
...
#line 74 "pl0.y"
    {
                ...
                printf("%s\n", $2);
                */
                //here I can print the final "}" for the end of main
                printf("%s\n", (yyvsp[(1) - (2)].sval));
            }
    break;
...
#line 168 "pl0.y"
    {
                //maybe here put a flag to see if I'm in the local block to be able to properly print 'main'
                ;
            }
    break;
